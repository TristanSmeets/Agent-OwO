...
newUI0.Position = { x = 959.7, y = 454, z = 0 }
newUI0.Rotation = { x = 0, y = 0, z = 0, w = 1 }
newUI0.Scale = { x = 1, y = 1, z = 1 }
newUI0.Height = 146
newUI0.Width = 380
newUI0.Type = 'BUTTON'
newUI0.ButtonType = 'CONTINUE'
newUI0.ImagePath = 'mge/UI/Continue_button.png'
...
newUI2.Position = { x = 959.64, y = 607, z = 0 }
newUI2.Rotation = { x = 0, y = 0, z = 0, w = 1 }
newUI2.Scale = { x = 1, y = 1, z = 1 }
newUI2.Height = 146
newUI2.Width = 380
newUI2.Type = 'BUTTON'
newUI2.ButtonType = 'EXIT'
newUI2.ImagePath = 'mge/UI/Exit_button.png'
